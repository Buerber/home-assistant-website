...
Currently, there are no configuration options available for these cards. You can configure them on the [energy configuration page](https://my.home-assistant.io/redirect/config_energy).

## Energy date picker 

![Screenshot of the Energy date selection card.](./img/energy_1.png)
<p className='text-center font-extralight'>Screenshot of the Energy date selection card.</p>
...
![Screenshot of the Energy usage graph card.](./img/energy_2.png)
<p className='text-center font-extralight'>Screenshot of the Energy usage graph card.</p>
...
![Screenshot of the Solar production graph card.](./img/energy_3.png)
<p className='text-center font-extralight'>Screenshot of the Solar production graph card.</p>
...
![Screenshot of the gas consumption graph card.](./img/energy_4.png)
<p className='text-center font-extralight'>Screenshot of the gas consumption graph card.</p>
...
![Screenshot of the water consumption graph card.](./img/energy_5.png)
<p className='text-center font-extralight'>Screenshot of the water consumption graph card.</p>
...
![Screenshot of the Energy distribution card.](./img/energy_6.png)
<p className='text-center font-extralight'>Screenshot of the Energy distribution card.</p>
...
![Screenshot of the Energy sources table card.](./img/energy_7.png)
<p className='text-center font-extralight'>Screenshot of the Energy sources table card.</p>
...
![Screenshot of the Solar consumed gauge card.](./img/energy_8.png)
<p className='text-center font-extralight'>Screenshot of the Solar consumed gauge card.</p>
...
![Screenshot of the Carbon consumed gauge card.](./img/energy_9.png)
<p className='text-center font-extralight'>Screenshot of the Carbon consumed gauge card.</p>
...
![Screenshot of the self-sufficiency gauge card.](./img/energy_10.png)
<p className='text-center font-extralight'>Screenshot of the self-sufficiency gauge card.</p>
...
![Screenshot of the devices energy graph card.](./img/energy_11.png)
<p className='text-center font-extralight'>Screenshot of the devices energy graph card.</p>
...
![Screenshot of the detail devices energy graph card.](./img/energy_12.png)
<p className='text-center font-extralight'>Screenshot of the detail devices energy graph card.</p>
...
![Screenshot of the sankey energy graph card.](./img/energy_13.png)
<p className='text-center font-extralight'>Screenshot of the sankey energy graph card.</p>
