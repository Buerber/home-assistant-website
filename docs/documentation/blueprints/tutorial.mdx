...
- This tutorial assumes knowledge in the following topics:
    - [Editing the configuration file](/docs/documentation/configuration/)
    - [YAML](/docs/documentation/configuration/yaml), and specifically, [YAML used in automations](/docs/documentation/automation/yaml)
...
1. Find the **Motion Light Tutorial** blueprint and select **Create Automation**.
...
![Screenshot of the blueprint UI](./img/tutorial_1.png)
